...
import 'berserker_model.dart';
export 'berserker_model.dart';

class BerserkerWidget extends StatefulWidget {
  const BerserkerWidget({super.key});

  @override
  State<BerserkerWidget> createState() => _BerserkerWidgetState();
}

class _BerserkerWidgetState extends State<BerserkerWidget> {
  late BerserkerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BerserkerModel());
