...
import 'symbioz_model.dart';
export 'symbioz_model.dart';

class SymbiozWidget extends StatefulWidget {
  const SymbiozWidget({super.key});

  @override
  State<SymbiozWidget> createState() => _SymbiozWidgetState();
}

class _SymbiozWidgetState extends State<SymbiozWidget> {
  late SymbiozModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SymbiozModel());
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Text(
                FFLocalizations.of(context).getText(
                  'mimxrjt2' /* Bradypus tridactylus, Paresseu... */,
                ),
              ...
              Align(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    '9od81gnu' /* Utilisez cette vidéo pour retr... */,
                  ),
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'xehmtnvz' /* Le code est : nombre de griffe... */,
                ),
                style: FlutterFlowTheme.of(context).bodyMedium.override(
                      fontFamily: 'Oswald',
                      fontSize: 17.0,
              ...
              FFButtonWidget(
                onPressed: () async {
                  if (FFAppState().Difficulte == true) {
                    if (_model.textController.text == '28') {
