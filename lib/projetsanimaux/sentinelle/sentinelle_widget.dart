...
import 'sentinelle_model.dart';
export 'sentinelle_model.dart';

class SentinelleWidget extends StatefulWidget {
  const SentinelleWidget({super.key});

  @override
  State<SentinelleWidget> createState() => _SentinelleWidgetState();
}

class _SentinelleWidgetState extends State<SentinelleWidget> {
  late SentinelleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SentinelleModel());
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    FFLocalizations.of(context).getText(
                      'xrp1zqn1' /* Bubo bubo, Grand-duc d'Europe */,
                    ),
                  ...
                  Align(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'e8rfjiyb' /* Utilisez cette vidéo pour retr... */,
                      ),
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      '26qkl0j5' /* Le code est : nombre de doigts... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Oswald',
                          fontSize: 17.0,
