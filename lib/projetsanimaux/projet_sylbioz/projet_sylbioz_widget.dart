...
import 'projet_sylbioz_model.dart';
export 'projet_sylbioz_model.dart';

class ProjetSylbiozWidget extends StatefulWidget {
  const ProjetSylbiozWidget({super.key});

  @override
  State<ProjetSylbiozWidget> createState() => _ProjetSylbiozWidgetState();
}

class _ProjetSylbiozWidgetState extends State<ProjetSylbiozWidget> {
  late ProjetSylbiozModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjetSylbiozModel());
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.network(
                                  'https://fichier.adam-marzuk.fr/img/symbiose%20en%20facile.png',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag3',
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.network(
                                  'https://fichier.adam-marzuk.fr/img/symbiose%20en%20difficile.png',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag4',
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.network(
                                  'https://fichier.adam-marzuk.fr/img/symbiose%20es%20facile.png',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag5',
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.network(
                                  'https://fichier.adam-marzuk.fr/img/symbiose%20es%20difficile.png',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag6',
